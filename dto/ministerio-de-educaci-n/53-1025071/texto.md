...
El establecimiento educacional deberá contar, como mínimo, con los elementos de enseñanza y material didáctico que se indican a continuación, para el nivel y modalidad educacional que corresponda:
...
. Obras literarias (entre un 40 y 60% de la colección): cuentos, fábulas y leyendas tradicionales, poesía y lírica, teatro, novelas, entre otros.

. Obras informativas (proporción complementaria de las obras literarias): material de referencia y consulta para los alumnos (diccionarios, enciclopedias, atlas geográficos actualizados, obras musicales reproducibles, material audiovisual: variedad de películas animadas y no animadas, documentales, series de televisión, entre otros), que abarquen diversas temáticas, tales como: Lenguaje, Matemática, Ciencias Naturales, Historia, Geografía y Ciencias Sociales, Idioma Extranjero, Artes Visuales y Música, entre otros.

. *El Ministerio de Educación pondrá a disposición de los establecimientos educacionales un listado con títulos de libros recomendados para este nivel en la página web de la Biblioteca CRA.

1.2 Biblioteca de aula en 1º básico

El establecimiento deberá contar con una biblioteca de aula para 1º básico además de la colección básica antes mencionada.

La biblioteca de aula deberá contar con libros en cantidad suficiente (al menos 1 por alumno/a) en buen estado, narrativos e informativos, con imágenes y textos simples y predecibles, en relación a temáticas y géneros adecuados a la edad.
...
El establecimiento deberá contar con material de apoyo al docente para realizar sus clases como para su desarrollo profesional.
...
2.3 Suscripción a periódico y revista

El establecimiento deberá contar con la suscripción a un periódico de circulación nacional o regional y a una revista profesional o específica de una asignatura.

2.4 Material audiovisual

El establecimiento deberá contar con al menos un equipo portátil reproductor de música y un aparato que esté operativo y que permita la reproducción de material audiovisual.

2.5 Material de reproducción

El establecimiento deberá poseer un método de multicopiado que permita a los profesores reproducir material escrito, como por ejemplo: fotocopiadora, impresora, sistema externalizado de fotocopias, entre otros.

2.6 Material tecnológico: CRA
...
. Obras literarias (entre un 40 y 60% de la colección): cuentos, fábulas y leyendas tradicionales, poesía y lírica, teatro, novelas, entre otras.

. Obras informativas (proporción complementaria de las obras literarias): material de referencia y consulta para los alumnos (diccionarios, enciclopedias, atlas geográficos actualizados, obras musicales reproducibles, material audiovisual: variedad de películas animadas y no animadas, documentales, series de televisión, entre otros), que abarquen diversas temáticas, tales como: Lenguaje, Matemática, Ciencias Naturales, Historia, Geografía y Ciencias Sociales, Filosofía, Idioma Extranjero, Artes Visuales y Música, entre otras.

* El Ministerio de Educación pondrá a disposición de los establecimientos educacionales un listado con títulos de libros recomendados para este nivel en la página web de la Biblioteca CRA.

1.2 Material didáctico para apoyar las clases
...
En la biblioteca escolar CRA o en el lugar que se destine a conservar la colección básica de libros y recursos, el establecimiento deberá contar al menos con un texto de carácter avanzado por docente para cada asignatura: por ejemplo, libros especializados en Matemática, Biología, Química, Física, Geometría, Álgebra, Historia de Chile, Historia Universal, Gramática y Ortografía, Filosofía, Arte, Música y otras obras generales para la consulta de los docentes.
...
El establecimiento deberá poseer un método de multicopiado que permita a los profesores producir material escrito, como por ejemplo: fotocopiadora, impresora, sistema externalizado de fotocopias, entre otros.

2.6 Computadores para docentes

La sala de profesores deberá contar con un computador cada 6 cursos que tenga el establecimiento, con un mínimo de un computador.

2.7 Material tecnológico: CRA
