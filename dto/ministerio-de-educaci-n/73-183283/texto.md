...
Los recursos del Fondo Concursable para Escuelas Artísticas, se destinarán a apoyar el desarrollo de los establecimientos educacionales especializados en educación artística reconocidos, destinándose al financiamiento total o parcial de los proyectos, programas y acciones referidos a:
...
Los proyectos deberán presentarse individualizados y descritos en forma que determine la autoridad convocante, según el contenido de las bases y formularios de postulación.
...
El representante legal del establecimiento responsable de cada proyecto seleccionado, deberá firmar un convenio de ejecución del proyecto con el Ministerio de Educación, que contendrá los derechos y obligaciones de ambas partes.
