...
a) Lo solicitado por la interesada mediante Ingreso Subtel Nº 10.713 del 21.01.98.
...
2.1 A lo menos un teléfono público o centro de llamadas en cada una de las localidades señaladas en las bases específicas del Proyecto Tocopilla, Código 97202303, según el siguiente cuadro:

Localidad Comuna Región

Caleta Buena Tocopilla 2

Caleta Cobija Tocopilla 2
...
3. Apruébase el proyecto técnico base de la solicitud presentado por la concesionaria, correspondiente a su propuesta relativa al Proyecto Tocopilla, Código 97202303, en lo concerniente a los sistemas y equipos de telecomunicaciones autorizados en el presente decreto, conforme a las disposiciones técnico legales que rigen el servicio de telecomunicaciones concedido. La documentación respectiva quedará archivada en la Subsecretaría de Telecomunicaciones, en adelante la Subsecretaría.

El monto del subsidio asignado a la concesionaria es de cero pesos ($0).

Las Bases Generales y las Bases Específicas del Proyecto Tocopilla, correspondientes al segundo llamado a concurso público para la asignación de proyectos y sus respectivos subsidios del Programa 1997 del Fondo de Desarrollo de las Telecomunicaciones, forman parte integrante del presente decreto, para todos los efectos administrativos y legales.
...
T = Período de cobro mínimo de la llamada local, establecido por la concesionaria, expresado en minutos
...
ICMO = Indice de Costo de Mano de Obra publicado por el INE, siendo ICMOt el valor del mes anterior al de aplicación de la tarifa e ICMO0 el valor del mes de noviembre de 1995.
