OTORGA CONCESION DE SERVICIO PUBLICO DE REPETIDORA COMUNITARIA DEL TIPO URC-CONVENCIONAL A SOCIEDAD DE TELECOMUNICACIONES TELSA LIMITADA
...
Considerando: Lo solicitado por la interesada mediante ingreso Subtel Nº 17.256, del 30.06.98,

D e c r e t o:

1.- Otórgase concesión de Servicio Público de Repetidora Comunitaria del tipo URC-Convencional, a la Sociedad de Telecomunicaciones Telsa Ltda., Rut. Nº 78.606.120-2, con domicilio en calle Bulnes Nº 720, comuna de Chillán, VIII Región, en adelante la concesionaria, en el sentido que se indica en los numerandos siguientes.

2.- Autorízase a la concesionaria para instalar, operar y explotar una estación repetidora en la VIII Región.

Características técnicas comunes:

- Frecuencias : F = 154,275 MHz. F' = 149,525

MHz.

- Tipo de emisión : 16K0F3EJN

- Zona de servicio : Estará definida por un contorno

de 16 µV/m en torno a la

estación repetidora.

Estación repetidora Los Guanacos:

- Frecuencias (Tx, Rx) : (F', F).

- Potencia máxima : 50 Watts.

- Sistema radiante : Antena omnidireccional de 6 dBd

de ganancia, con polarización

vertical.

- Ubicación : Cerro Los Guanacos, comuna de

Los Angeles, VIII Región.

- Coordenadas geográficas: 37°19'02" Latitud Sur.
...
- Sistema radiante : Antena omnidireccional de 3 dBd
...
- Sistema radiante : Antena incorporada al equipo de
...
4. El plazo para iniciar la construcción de las obras será de 3 meses y para su término de 10 meses. Asimismo, el plazo para iniciar el servicio será de 12 meses. Todos estos plazos serán contados desde la fecha de publicación en el Diario Oficial del presente decreto.
