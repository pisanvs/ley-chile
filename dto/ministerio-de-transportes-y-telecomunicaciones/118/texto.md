...
a) Lo solicitado por la interesada mediante Ingreso Subtel N° 11.511 de 13.02.96.

b) El Acta del 26.01.96, correspondiente a la quinta sesión del Consejo de Desarrollo de las Telecomunicaciones.

c) Lo informado por la Subsecretaría de Telecomunicaciones por Oficio Ord. N° 31.370 del 19.04.96.
...
2. Apruébase el proyecto técnico base de la solicitud (FD-96/05), presentado por la concesionaria, correspondiente a su propuesta relativa al proyecto Caldera, N° 9, Código 950609, en lo concerniente a los sistemas y equipos de telecomunicaciones que se instalarán, operarán y explotarán conforme a las disposiciones técnico legales que rigen el servicio de telecomunicaciones concedido. La documentación respectiva quedará archivada en la Subsecretaría de Telecomunicaciones, en adelante la Subsecretaría.

El monto del subsidio asignado a la concesionaria es de $3.748.355. Impútese este gasto al ítem N° 19-02-01-33-85-001- "Fondo de Desarrollo de las Telecomunicaciones" del presupuesto vigente.

Las Bases Generales y las Bases Específicas del Proyecto Caldera, correspondientes al llamado a concurso público para la asignación de proyectos y sus respectivos subsidios del Programa 1995 del Fondo de Desarrollo de las Telecomunicaciones, aprobadas por la Resolución Exenta N° 591 de 1995, de la Subsecretaría, forman parte integrante del presente Decreto, para todos los efectos administrativos y legales.

3. Autorízase a la concesionaria para instalar, operar y explotar lo siguiente:

3.1. Afecto a subsidio: Un teléfono público en la localidad de Puerto Viejo, III Región.

3.2. No afecto a subsidio: Líneas de abonado en la localidad señalada en el punto 3.1, dentro del ámbito de cobertura de los medios de transmisión instalados, sin exceder los límites geográficos de la zona primaria respectiva.

El teléfono público y líneas de abonado se conectarán a la red pública telefónica mediante un radioenlace. Las características técnicas y la ubicación de los sistemas radiantes serán las siguientes:

_______________________________________________________

| NOTA: VER DIARIO OFICIAL N° 35.526, VIERNES 26 DE |

| JULIO DE 1996, PAGINA 10. |

|_____________________________________________________|

4. La zona de servicio comprende la localidad señalada en el punto 3.1. precedente.

5. La tarifa máxima a público que podrá aplicar la concesionaria, para las llamadas locales efectuadas a través del teléfono público, durante los primeros 10 años de suministro del servicio telefónico, expresada en moneda de curso legal al 1° de enero de 1996, con IVA incluido, se calculará según la siguiente fórmula:
...
f corr = Factor de corrección de acuerdo al valor de T, según la siguiente tabla:
...
El período de cobro mínimo "T" no podrá ser superior a cinco minutos ni inferior a un minuto.

La concesionaria deberá informar a los usuarios en un lugar visible la tarifa aplicada, explicitando que ésta da derecho a efectuar una llamada local a cualquier destino dentro de la respectiva zona primaria, cuya duración podrá ser igual o inferior a dicho período "T".

La tarifa máxima a público, por llamada local, se reajustará por el índice IR, determinado según la siguiente fórmula:

IRt+1=(IPMt/IPM0)0,30 x (ICMOt/ICMO0)0,36 x

(US$At/US$A0)0,34 x ((1-tt)/(1-t0))-0,22

donde:

IPM = Indice de Precios al por Mayor publicado por el INE, siendo IPMt el valor del mes anterior al de aplicación de la tarifa e IPM0 el valor de noviembre de 1995.

ICMO = Indice de Costo de Mano de Obra publicado por el INE, siendo ICMOt el valor del mes anterior al de aplicación de la tarifa e ICMO0 el valor de noviembre de 1995.
...
t = Tasa de impuesto a las utilidades, siento t0 igual a 15% y tt la tasa de impuesto a las utilidades vigente al término del mes anterior al de aplicación de la tarifa.
...
11. El plazo para iniciar la construcción de las obras será de 1 mes y para su término de 4 meses. Asimismo, el plazo para iniciar el servicio será de 6 meses. Todos estos plazos serán contados a partir de la fecha de publicación en el Diario Oficial del presente Decreto.
