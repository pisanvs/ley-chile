...
Reglamento del Fondo de Desarrollo de las

Telecomunicaciones.

e) El Nº 1 del artículo 3º párrafo III de la

resolución Nº 55 de 1992, cuyo texto refundido,
...
2.1 A lo menos un teléfono público o centro de llamadas en cada una de las localidades señaladas en las bases específicas del Proyecto Diego de Almagro, Código 97203405, según el siguiente cuadro:

Localidad Comuna Reg.

Intelec Diego de Almagro 3

Portal del Inca Diego de Almagro 3
...
F2 = 264,025 F2' = 274,025 10 16K0F3EJN Antenas Yagi
...
Intelec Terminal F1' F1 El Salvador

Portal del Inca Terminal F2' F2 El Salvador

UBICACION RADIOESTACIONES

VER D.O. DE FECHA 10.08.1998

3. Apruébase el proyecto técnico base de la solicitud presentado por la concesionaria, correspondiente a su propuesta relativa al Proyecto Diego de Almagro, Código 97203405, en lo concerniente a los sistemas y equipos de telecomunicaciones autorizados en el presente decreto, conforme a las disposiciones técnico legales que rigen el servicio de telecomunicaciones concedido. La documentación respectiva quedará archivada en la Subsecretaría de Telecomunicaciones, en adelante la Subsecretaría. El monto del subsidio asignado a la concesionaria es de cero pesos ($0).

Las Bases Generales y las Bases Específicas del Proyecto Diego de Almagro, correspondientes al segundo llamado a concurso público para la asignación de proyectos y sus respectivos subsidios del Programa 1997 del Fondo de Desarrollo de las Telecomunicaciones, forman parte integrante del presente Decreto, para todos los efectos administrativos y legales.
...
publicado por el INE, siendo IPMt, el valor del mes

anterior al de aplicación de la tarifa e IPM0 el valor

del mes de noviembre de 1995.

ICMO = Indice de Costo de Mano de Obra

publicado por el INE, siendo ICMOt el valor del mes

anterior al de aplicación de la tarifa e ICMO0 el valor
...
aplicación de la tarifa; y (1+tasa arancelaria)0 igual a

1,11.

t = tasa de impuesto a las utilidades,

siendo t0 igual al 15% y tt la tasa de impuesto a las
...
7. El plazo para iniciar la construcción de las obras será de 2 meses y para su término de 4 meses. Asimismo, el plazo para iniciar el servicio será de 6 meses. Todos estos plazos serán contados desde la fecha de publicación en el Diario Oficial del presente decreto.
