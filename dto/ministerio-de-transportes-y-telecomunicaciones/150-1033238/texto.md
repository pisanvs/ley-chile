...
1.9. Subprograma Confinamiento de Vías
...
- Durante el año 2010, se registraron 312 accidentes en la vía férrea, en los cuales se produjeron 37 muertes (35 en atropellos y 2 en colisiones).

- Hubo 69 atropellos que representan 22% del total. Sin embargo, los tramos claramente identificados son: Alameda-Nos que representa el 30,4% de los atropellos, Nos-San Fernando representa el 26% de los atropellos.

- En el tramo Alameda-San Fernando se registró el 56,4% de los atropellos.

Las colisiones fueron 57, representando un 18,2% del total de accidentes.

Presupuesto y ejecución del Subprograma

Estos subprogramas tienen el siguiente plan de inversión general:

.

1.10. Subprograma Protección de Cruces
...
1.11. Subprograma Recuperación de Activos dañados en Terremoto
...
1.12. Subprograma Recuperación Líneas Clase 2
...
4.2. Subprograma Integración Trenes Metropolitanos con Transporte Público
...
El estudio de nivel estratégico tuvo auditoría independiente y un sistema de contrapartes conformado por EFE, Mideplan-Sectra y MTT. Los indicadores de rentabilidad social del "proyecto de integración", desarrollado por SDG superan el umbral definido por Mideplan, inclusive bajo dos consideraciones: evaluación social tradicional e incluyendo adicionalmente reducción de externalidades negativas completas atribuibles al proyecto. Siguiendo con esa línea de análisis, la Filial TMSA desarrolló un análisis más táctico, que identifica en mayor detalle el conjunto de acciones para operacionalización de la integración.
...
En efecto, debido a la dinámica urbana, los centros poblaciones de estas localidades se han alejado de las estaciones, que naturalmente continúan emplazadas en el trayecto original de la línea férrea, por lo que el grado de accesibilidad es complejo para los usuarios, ya que no cuentan con servicios de acercamiento.

Una Estación de Metrotren tiene una afluencia promedio de 2.400 o más pasajeros en hora punta. En un día representativo, el servicio Metrotren capta alrededor de 20.000 pasajeros en el total de su red (contabilizados por venta de pasajes). Sin embargo, en las 5 estaciones mencionadas anteriormente, los pasajeros se encuentran debajo de la media, en al menos un 20% (promedio).
...
Mejoramiento Calidad de Servicio en Estaciones TMSA
...
- Implementar un sistema de iluminación directa en el sector de andenes y torniquetes, de bajo costo operacional y de mantención, que entregue sensación de seguridad y confort a los clientes del servicio Metrotren.

- Mejorar cobertizos y asientos, de modo tal de entregar niveles de comodidad y confort adecuados para el trasbordo y espera de pasajeros.

- Entregar a los pasajeros información y comunicación visual, tanto de paneles electrónicos "video-wall" y mensajería, como de señalética, de manera que apoye la operación en la forma más eficiente posible y, así, que los usuarios no cometan errores o pierdan tiempo en informarse.

- Facilitar la circulación peatonal y vehicular a los pasajeros que llegan o salen de las estaciones, mejorando las calzadas, calles de acceso y estacionamiento.

Adquisición y Estrategia Mantenimiento de Trenes TMSA

Definir el tipo de vehículo (capacidad; modularidad; líneas de producción; nuevos/usados, etc.) y la cantidad requerida (compra, arrendamiento, leasing, etc.), para cubrir la demanda estimada para el año 2014, incorporando eventualmente las nuevas líneas y estaciones.

Indagar y definir las estrategias de mantenimiento acorde a las necesidades del servicio y del vehículo propuesto, considerando al 2013 el término del contrato con Temoinsa.
...
La afluencia proyectada para el proyecto de integración del servicio:
...
4.3. Subprograma de Sistema de Tranvía Urbano en Concepción
...
4.4. Subprograma Mejoramiento Corto Laja
...
4.5. Subprograma Nuevo Trazado Santiago - Valparaíso
...
4.6. Subprograma de Inversión Adicional Servicio Rancagua Express

El servicio Rancagua Express considera mejoras en el servicio entre Santiago y Rancagua, dividido en 2 tramos:

- Servicio expreso Santiago - Rancagua en 50 min.

- Servicios suburbanos Santiago - San Bernardo en 15 min., integrado al sistema de transporte público de la Región Metropolitana.
...
- Ahorro de tiempo de pasajeros de una hora diaria en cada viaje vis à vis con bus.
...
La inversión estimada considera que se deben realizar obras en:

- Renovar flota de trenes.

- Resolver cruces a nivel y pasarelas peatonales.

- Confinar la vía Santiago - Rancagua: seguridad y confiabilidad.
...
Considera la realización de la Ingeniería de Detalle de la Obras Civiles a construir y las EETT del Material Rodante. Además, incluye consultorías específicas e Inspección Técnica de Obras en la etapa de construcción.
