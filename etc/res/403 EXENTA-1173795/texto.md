...
9. Establécese, para las regiones que a continuación se identifican, que el monto de subsidio base para los proyectos que participen del presente llamado, es el que se define a continuaci�n, al que se le aplicará el factor multiplicador definido en la resolución exenta N° 1.874 (V. y U.), de 2015, según la comuna donde se ubique el proyecto:
