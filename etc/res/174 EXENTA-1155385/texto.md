EXTRACTO RESOLUCIÓN Nº 174 EXENTA, DE 2021, DE SUBTEL

Por resolución exenta Nº 174, de 25.01.2021, del Ministerio de Transportes y Telecomunicaciones, que se extracta, se asignó a la empresa ENTEL PCS TELECOMUNICACIONES S.A., rol único tributario Nº 96.806.980-2, con domicilio en Amunátegui N° 20, Santiago, Región Metropolitana, una (1) concesión de servicio público de telecomunicaciones para la comuna de Calama, cuyos elementos relevantes son los siguientes:
...
5. Zona de servicio: área de cobertura georreferenciada que ha sido comprometida para cada una de las estaciones base incluidas en el proyecto técnico presentado respecto de la comuna de Calama.
