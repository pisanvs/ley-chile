...
1.- Prohíbase la circulación de todo tipo de vehículos motorizados, entre los días 1 y 11 de abril de 2016 (ambos inclusive), en la siguiente vía pública de la Comuna de Copiapó:
...
3.- La empresa a cargo de las obras, deberá respetar estrictamente el periodo de cierre de la Avenida en los tramos indicados en la presente resolución y señalizará debidamente el sector de los trabajos de acuerdo al Manual de Señalización de Tránsito "Señalización Transitoria y Medidas de Seguridad para Trabajos en la Vía", Capítulo 5 del Ministerio de Transportes y Telecomunicaciones (www.conaset.cl), debiendo adoptar todas las medidas necesarias que permitan el normal desarrollo de las obras.
