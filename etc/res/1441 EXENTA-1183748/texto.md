...
2. El monto de los recursos que se destinarán para el subsidio directo en el presente llamado, conforme a las disposiciones del DS Nº 1, será de 217.734 Unidades de Fomento (UF), de acuerdo a la siguiente distribución regional, la que podrá modificarse en atención a la oferta presentada:
...
c. No se aplicará lo señalado respecto a la loggia.
...
a. Lo señalado en el artículo 48 del DS Nº 1, en sus letras

- **a)** Coordenadas de georreferenciación (x,y) y dirección del proyecto,

- **b)** Plano de emplazamiento del loteo, y

- **c)** Permiso de edificación acompañando los antecedentes señalados en los acápites c1), c2) y c3).
...
a. Acreditar un estado de avance de obras de construcción de al menos un 40% a la fecha de ingreso de la postulación.
...
c) Si se trata de adquisición de viviendas, el Serviu pagará el subsidio cuyo cobro se presente dentro de los 18 meses contados desde la inscripción de dominio. Para lo anterior, se deberá acompañar copia de la inscripción en el Registro de Propiedad del Conservador de Bienes Raíces competente de la transferencia de dominio del inmueble a nombre del beneficiario.
