AUTORIZA A CONTRIBUYENTE QUE INDICA PARA QUE OPERE EN LA INTERMEDIACION DE INFORMACION QUE SEÑALA Santiago, 4 de Septiembre de 1995.- Hoy se ha resuelto lo que sigue:

Núm. 4.308 exenta.- Vistos: Lo dispuesto en el artículo 6°, letra A), N° 1, del Código Tributario, contenido en el artículo 1° del decreto ley N° 830, de 1974; en la Resolución Exenta N° 1.515, publicada en el Diario Oficial de 03 de abril de 1995, la solicitud de autorización respecto de la Intermediación de Documentos Tributarios Electrónicos de 5 de Mayo de 1995, y Considerando: Que, el contribuyente indicado cumple debidamente con las exigencias técnicas necesarias para asegurar, por una parte el debido resguardo y reserva de la información y por otra, la veracidad de ésta.

Se resuelve:

1.- Autorízase a la empresa EDIBANK S.A., Rol Unico Tributario N° 96.689.310-9, domiciliada en Huérfanos N° 770, piso 18, Comuna de Santiago, para que preste servicios de transmisión electrónica de la información tributaria, entre dos o más contribuyentes, debiendo para ello, cumplir con las siguientes exigencias, sin perjuicio del cumplimiento de aquellas establecidas en el N° 2 de la Resolución Ex. N° 1.515, publicada en el Diario Oficial del 03 de Abril de 1995:
...
1.- Recepción y distribución de mensajes electrónicos mediante el uso de protocolos de comunicaciones, tales como el Frame Relay y el ISDN, enlaces dedicados y conmutados;

2.- El almacenamiento de los mensajes se hace a través de un sistema de casillas electrónicas.

3.- Los elementos de seguridad, están basados en las recomendaciones dadas por las Naciones Unidas, y EDI Chile para los intercambios de mensajes EDIFACT. Para los efectos de la implementación de los mecanismos de firma electrónica y encriptación que requieren estas recomendaciones, se utilizan algunos elementos de software llamados SCORE API. Estos procesos combinan los sistemas criptográficos DES - que corresponde a la norma ANSI X3.92-1981 y RSA - correspondiente a la norma ISO 11116 y ANSI X9.30 -, y

4.- Tiene una configuración computacional de alta disponibilidad, consistente en una red de servidores especializados, interconectados bajo la norma Ethernet y que utiliza las normas TCP/IP y X.400 para el intercambio de mensajes al interior de la red.
