...
3. La prestación de servicios de asistencia técnica y fiscalización técnica de las obras identificadas en las letras a), b),

- **c)** y d), del numeral 2 precedente, financiadas a través de los programas habitacionales señalados en la presente resolución, se regularán y financiarán a través de las resoluciones de asistencia técnica que identifican las letras k),

- **l)** y

- **m)** de los Visto señalados en la presente resolución. Adicionalmente, otros pagos relacionados con actividades, trámites, servicios y gestiones relacionadas con materias a las que alude la Res. Ex. N° 1.891 (V. y U.) de 2020, sobre prestación de servicios de asistencia técnica previa, podrán financiarse, cuando corresponda y sea pertinente, con cargo a los recursos de asistencia técnica identificados a través de la misma resolución para cada Serviu, siempre y cuando se cumpla con la normativa establecida y exista disponibilidad presupuestaria para su financiamiento.
