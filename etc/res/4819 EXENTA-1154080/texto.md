...
ii. Promedio Histórico < Promedio Acumulado ≤ Promedio Máximo Histórico: En este escenario el Puntaje Ranking es mayor que el Puntaje NEM y aumenta linealmente con el Promedio Acumulado hasta 1.000 puntos. Los 1.000 puntos se obtienen cuando el Promedio Acumulado es igual al Promedio Máximo Histórico. La relación entre el Promedio Acumulado y el Puntaje Ranking es descrita por la ecuación 1:
...
Lo dispuesto en el artículo segundo, numeral 4.1.1.1, acápite "Etapa de inscripción a la prueba de admisión", subtítulo "Deberes", literal e.4, será aplicable a los postulantes del proceso de admisión 2022, que se encuentren en las situaciones descritas.
