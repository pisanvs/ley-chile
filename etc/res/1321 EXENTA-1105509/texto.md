...
La respectiva asignación de frecuencias se realizará caso a caso, acorde a factibilidad técnica sin interferir a los servicios existentes a la fecha de la presente resolución y sin protección contra eventuales interferencias de aplicaciones similares.

#### Artículo 5°

Las frecuencias que se autoricen podrán ser compartidas con otras permisionarias, según los requerimientos de uso del espectro radioeléctrico.

#### Artículo 6°

La zona de servicio deberá ser la mínima necesaria para satisfacer los requerimientos planteados como objetivos por las solicitantes, en el marco de aplicaciones de telecomunicaciones industriales.

#### Artículo 7°

Será obligación de las permisionarias, en caso de eventuales interferencias perjudiciales, coordinarse directamente entre ellas para efectos de eliminarlas.
