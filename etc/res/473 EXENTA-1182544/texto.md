...
4. Que, se considera necesario disponer de medidas fitosanitarias tendiente a contener o erradicar, cuando corresponda, la plaga Polilla del Racimo de la Vid.
...
6. Que, a la fecha se detectaron 27 ejemplares en el área que permite definir la zona afectada por la plaga.

Resuelvo:

1. Establécese como área reglamentada denominada "El Inca", para el control de la plaga Polilla de Racimo de la Vid (Lobesia botrana), el área de la ciudad de Copiapó de la comuna del mismo nombre, de la Provincia de Copiapó, Región de Atacama, inserta en el polígono de 58 vértices determinados por las siguientes coordenadas UTM que se señalan a continuación:
