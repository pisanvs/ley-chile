...
2°. Que las disposiciones contenidas en el literal

- **i)** de la letra

- **a)** del número 13; en la letra

- **a)** del número 25; en el numeral 17, letra b); en la letra

- **a)** del número 35, en la frase "por la Dirección General de Aguas"; y letra

- **b)** del mismo numeral 35, todas del artículo 1 del proyecto de ley remitido por el Congreso Nacional, son inconstitucionales y, en consecuencia, deben eliminarse del texto del proyecto.
