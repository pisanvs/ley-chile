...
- 5.504 toneladas a ser capturadas en el periodo
...
- 2.120 toneladas a ser capturadas en el periodo

comprendido entre el 1º septiembre y el 31 de

diciembre de 2006.

l) Sindicato de Trabajadores Independientes Pescadores Artesanales de la Caleta Cocholgue, Registro Sindical único 08.06.023: 64 toneladas anuales, las que se fraccionarán de la siguiente manera:

- 48 toneladas a ser capturadas en el periodo

comprendido entre la fecha de entrada en

vigencia del régimen establecido mediante

decreto exento Nº 290 de 2006, del Ministerio

de Economía, Fomento y Reconstrucción, y el

31 de agosto de 2006;

- 16 toneladas a ser capturadas en el periodo

comprendido entre el 1º de septiembre y el 31
...
- 1 tonelada a ser capturadas en el periodo comprendido entre el 1º septiembre y el 31 de diciembre de 2006.
...
- 26 toneladas a ser capturadas en el periodo
...
- 5 toneladas a ser capturadas en el periodo
...
- 136 toneladas a ser capturadas en el periodo
...
- 40 toneladas a ser capturadas en el periodo

comprendido entre el 1º septiembre y el 31 de

diciembre de 2006.

p) Asociación Gremial de Pescadores Artesanales de Caleta Infiernillo, Registro de Asociaciones Gremiales Nº 98-8: 4 toneladas anuales, las que se fraccionarán de la siguiente manera:
...
- 4 toneladas a ser capturadas en el periodo

comprendido entre el 1º septiembre y el 31 de

diciembre de 2006.

q) Asociación Gremial de Pescadores Artesanales de San Vicente Talcahuano, Registro de Asociaciones Gremiales Nº 18-8: 2.587 toneladas anuales, las que se fraccionarán de la siguiente manera:

- 1.867 toneladas a ser capturadas en el periodo
...
- 720 toneladas a ser capturadas en el periodo
...
- 300 toneladas a ser capturadas en el
...
- 114 toneladas a ser capturadas en el periodo
...
- 193 toneladas a ser capturadas en el periodo
...
- 13 toneladas a ser capturadas en el periodo

comprendido entre el 1º septiembre y el 31
...
- 598 toneladas a ser capturadas en el periodo
...
- 213 toneladas a ser capturadas en el periodo
...
- 192 toneladas a ser capturadas en el periodo
...
- 69 toneladas a ser capturadas en el periodo
...
- 2.069 toneladas a ser capturadas en el periodo
...
- 789 toneladas a ser capturadas en el periodo
...
- 552 toneladas a ser capturadas en el periodo
...
- 214 toneladas a ser capturadas en el periodo
...
- 412 toneladas a ser capturadas en el periodo
...
- 28 toneladas a ser capturadas en el periodo
...
- 11.175 toneladas a ser capturadas en el
...
- 1.300 toneladas a ser capturadas en el periodo
...
- 3.734 toneladas a ser capturadas en el periodo
...
- 403 toneladas a ser capturadas en el periodo
...
- 6.119 toneladas a ser capturadas en el periodo
...
- 731 toneladas a ser capturadas en el periodo
...
- 32.603 toneladas a ser capturadas en el
...
- 3.919 toneladas a ser capturadas en el periodo
...
- 8.721 toneladas a ser capturadas en el periodo
...
- 1.048 toneladas a ser capturadas en el periodo
...
- 2 toneladas a ser capturadas en el periodo
...
- 35.266 toneladas a ser capturadas en el
...
- 4.202 toneladas a ser capturadas en el periodo
...
- 74.842 toneladas a ser capturadas en el
...
- 8.990 toneladas a ser capturadas en el periodo
...
- 59.448 toneladas a ser capturadas en el
...
- 7.147 toneladas a ser capturadas en el periodo
...
- 12.664 toneladas a ser capturadas en el
...
- 1.523 toneladas a ser capturadas en el periodo
...
- 104 toneladas a ser capturadas en el periodo
...
- 22 toneladas a ser capturadas en el periodo
...
- 479 toneladas a ser capturadas en el periodo
...
- 18 toneladas a ser capturadas en el periodo
...
- 618 toneladas a ser capturadas en el periodo
...
- 41 toneladas a ser capturadas en el periodo

comprendido entre el 1º septiembre y el 31 de

diciembre de 2006.

p) Asociación Gremial de Pescadores Artesanales de Caleta Infiernillo, Registro de Asociaciones Gremiales Nº 98-8: 2 toneladas anuales, las que se fraccionarán de la siguiente manera:
...
q) Asociación Gremial de Pescadores Artesanales de San Vicente Talcahuano, Registro de Asociaciones Gremiales Nº 18-8: 4.815 toneladas anuales, las que se fraccionarán de la siguiente manera:

- 4.298 toneladas a ser capturadas en el

periodo comprendido entre la fecha de

entrada en vigencia del Régimen establecido

mediante Decreto Exento N° 290 de 2006, del

Ministerio de Economía, Fomento y

Reconstrucción, y el 31 de agosto de 2006;

- 517 toneladas a ser capturadas en el periodo
...
- 692 toneladas a ser capturadas en el periodo
...
- 82 toneladas a ser capturadas en el periodo
...
- 1.853 toneladas a ser capturadas en el periodo
...
- 61 toneladas a ser capturadas en el periodo
...
- 1.377 toneladas a ser capturadas en el periodo
...
- 156 toneladas a ser capturadas en el periodo
...
- 540 toneladas a ser capturadas en el periodo
...
- 53 toneladas a ser capturadas en el periodo
...
- 4.760 toneladas a ser capturadas en el periodo
...
- 568 toneladas a ser capturadas en el periodo
...
- 1.276 toneladas a ser capturadas en el periodo
...
- 154 toneladas a ser capturadas en el periodo

comprendido entre el 1º septiembre y el 31 de

diciembre de 2006.

2º-. Las organizaciones de pescadores artesanales podrán operar los días de captura establecidos en la Resolución Nº 1092 de 2006 de esta Subsecretaría. Asimismo, el Servicio Nacional de Pesca podrá establecer horarios de desembarques.
