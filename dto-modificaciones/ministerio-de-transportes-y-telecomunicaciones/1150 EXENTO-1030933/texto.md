...
a) Lo solicitado por la interesada mediante ingreso Subtel Nº 54.551 de 13.12.2010.

b) La solicitud de autorización provisoria de la modificación de la concesión indicada en la letra precedente, ingreso Subtel Nº 55.178 de 15.12.2010, por cuyo intermedio la interesada expuso los fundamentos de su petición, en torno a la gravedad y urgencia que justifican acceder a ella.
...
1.1 Autorízase a la concesionaria para modificar la ubicación de once (11) Estaciones Base.

1.2. Autorízase a la concesionaria para modificar la dirección de dos (2) Estaciones Base.

1.3. Autorízase a la concesionaria para instalar, operar y explotar una (1) Estación Base.
