...
A) Las características y la ubicación del

equipamiento que se retira son las siguientes:

Centrales Telefónicas combinadas, local y larga distancia.

1.- Central telefónica: Rapel. Dirección: C. Público s/n. Sistema: Manual MG, Pos. Mural 21100. Equipo instalado: 20 Ls., 1 Pos.
...
Nombre o localidad: Monte Patria. Dirección:

Arturo. Prat 085, Sistema: Manual MG, Pos CTC-

Stand. Equipo instalado: 50 Ls., 1 Pos.
...
3.- La zona de servicio de la central manual de RapeI es la misma autorizada por decreto Nº 202 del Ministerio de Transportes y Telecomunicaciones.
