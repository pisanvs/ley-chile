...
a) Lo solicitado por la interesada mediante Ingreso Subtel Nº66.289 de 29.11.2006.

b) La solicitud de autorización provisoria de la edificación de la concesión indicada en la letra precedente, Ingreso Subtel Nº68.698 de 13.12.2006, por cuyo intermedio la interesada expuso los fundamentos de su petición, en torno a la gravedad y urgencia que justifican acceder a ella.
...
1. Autorízase a la concesionaria para instalar, operar y explotar dos (2) nuevos Media Gateway (MGW), dos (2) nuevos Centros de Conmutación Móvil (MSC Server) con sus respectivos Controladores de Estaciones Base (BSC) y un (1) nuevo Nodo Controlador de Red de Radio (RNC), que se indican a continuación:

VER DIARIO OFICIAL DE 14.06.2007, PÁGINA 19.

2. Instalar, operar y explotar siete (7) nuevas Estaciones Base, que se indican a continuación:

VER DIARIO OFICIAL DE 14.06.2007, PÁGINA 19.

Las Estaciones, que se autorizan, se conectarán la red existente, a través de medios propios o arrendados a terceros.
