...
a) Lo solicitado por la interesada mediante ingreso Subtel Nº 77.415, de 27.04.2020.
...
1. Autorízase a la concesionaria a modificar su concesión en el sentido de instalar, operar y explotar dos (2) Nodos y tramos de fibra óptica en la comuna de Copiapó, Región de Atacama, según se indica a continuación:

.

Desde los nodos se tenderá la fibra óptica pasiva de forma área, en la comuna de Copiapó, Región de Atacama.
