...
Esta modificación no implica alteraciones a la obligación que tiene la concesionaria sobre la atención de localidades incluidas en el proyecto Panguipulli código 97215257, del correspondiente programa de proyectos subsidiables del fondo de desarrollo de las telecomunicaciones, que dio origen a la concesión.
