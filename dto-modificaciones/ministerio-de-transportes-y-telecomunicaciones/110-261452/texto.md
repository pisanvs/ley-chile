...
a) Lo solicitado por la interesada mediante Ingreso Subtel Nº66.298 de 29.11.2006.

b) La solicitud de autorización provisoria de la modificación de la concesión indicada en la letra precedente, Ingreso Subtel Nº68.679 de 13.12.2006, por cuyo intermedio la interesada expuso los fundamentos de su petición, en torno a la gravedad y urgencia que justifican acceder a ella.
...
1. Autorízase a la concesionaria para instalar, operar y explotar un (1) nuevo Media Gateway y un (1) nuevo Controlador de Estaciones Base (BSC), que se indican a continuación:

NOTA: VER DIARIO OFICIAL DE 06.06.2007, PAGINA 18

2. Instalar, operar y explotar cuatro (4) nuevas Estaciones Base, que se indican a continuación:
