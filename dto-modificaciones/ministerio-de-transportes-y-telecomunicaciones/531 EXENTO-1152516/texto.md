...
a) Lo solicitado por la interesada mediante ingreso Subtel Nº 213.438 de 28.08.2020.
...
1. Autorízase a la concesionaria a modificar su concesión en el sentido de instalar, operar y explotar un (1) Nodo y tramos de fibra óptica en la comuna de Nancagua, Región del Libertador General Bernardo O'Higgins, según se indica a continuación:

.

Desde los nodos se tenderá la fibra óptica pasiva de forma área, en la comuna de Nancagua, Región del Libertador General Bernardo O'Higgins.
...
Zona Cobertura Nancagua :

.

Nota: La Zona 1 corresponde a la Etapa 1, según instalaciones indicadas en el proyecto técnico.
