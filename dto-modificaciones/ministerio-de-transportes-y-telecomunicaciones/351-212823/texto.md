...
Esta modificación no implica alteraciones a la obligación que tiene la concesionaria sobre la atención de localidades incluidas en el proyecto Purranque código 9747263, del correspondiente programa de proyectos subsidiables del fondo de desarrollo de las telecomunicaciones, que dio origen a la concesión.
