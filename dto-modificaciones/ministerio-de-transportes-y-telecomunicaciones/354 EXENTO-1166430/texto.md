...
a) Lo solicitado por la interesada mediante ingreso Subtel N° 87.528 de 06.05.2021.
...
1. Modificar su concesión en el sentido de ampliar su Zona de Servicio incorporando la comuna de El Monte, Región Metropolitana de Santiago.

El sistema de transmisión asociado a la zona de servicio que se incorpora en la comuna de El Monte, estará conformada por un sitio central compuesto por Equipos de Terminación de Línea Óptica (OLT), denominado HUB Maipú, autorizado por el decreto supremo N° 533 de 1998.

El sistema de transmisión al interior de la zona de servicio que se incorpora en la comuna de El Monte, estará conformada por un sitio central compuesto por equipos de Terminación de Línea Óptica (OLT), equipos de transmisión y amplificación óptica, una Red de Distribución Óptica (ODN), constituidos por elementos pasivos ópticos y cables de fibras ópticas y equipos de Terminación de Red Óptica (ONT), que es el elemento situado en casa del usuario.
