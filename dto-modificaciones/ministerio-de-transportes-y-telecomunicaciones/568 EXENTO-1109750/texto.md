...
a) Lo solicitado por la interesada mediante ingreso Subtel Nº138.369 de 07.11.2016.
...
1. Autorízase a la concesionaria para rectificar las coordenadas de una (1) estación base, autorizada por decreto supremo Nº 106 de 2007, quedando la ubicación como se indica a continuación:

.

2. También se aclara la dirección de la estación Base denominada "Quillón ETP", agregando el nombre del cerro en el cual se encuentra, quedando según se indica a continuación:
