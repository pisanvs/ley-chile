...
a) Lo solicitado por la interesada mediante ingreso Subtel Nº 142.539 de 26.06.2020.
...
1. Autorízase a la concesionaria a modificar su concesión en el sentido de instalar, operar y explotar un (1) nodo y tramos de fibra óptica en la comuna de Limache, Región de Valparaíso, según se indica a continuación:

Desde los nodos se tenderá la fibra óptica pasiva de forma aérea, en la comuna de Limache, Región de Valparaíso.
