...
Telecomunicaciones por Oficio Ord. N° 31.880 de 29.05.95.
...
2. Apruébase el proyecto técnico base de la solicitud (SP-94/121) presentado por la concesionaria, en lo concerniente a los sistemas y equipos de telecomunicaciones que se instalarán, operarán y explotarán, conforme a las disposiciones técnico legales que rigen el servicio de telecomunicaciones concedido.

La documentación respectiva quedará archivada en la Subsecretaría de Telecomunicaciones, en adelante la Subsecretaría.

3. Autorízase a la concesionaria para instalar, operar y explotar, en la Región Metropolitana, un centro telefónico digital, cuya ubicación, función, capacidad inicial y final de líneas son las siguientes:

_______________________________________________________

| NOTA: VER DIARIO OFICIAL N° 35.215 DEL DIA MIERCOLES|

| 12 DE JULIO DE 1995, PAGINA 11 |

|_____________________________________________________|

El Centro Satélite Andrés Bello II, dependerá del Centro Local Providencia I, el cual se irá adecuando, respecto a su capacidad de procesamiento, en la medida que así lo exijan las ampliaciones tanto propias (centro local), como de sus centros satélites.

El entronque del Centro Satélite Andrés Bello II con el Centro Local Providencia I, se realizará mediante sistemas de transmisión digital en cable de fibra óptica.

El centro considerado en el presente proyecto se interconectará a la red telefónica nacional a través del Centro Local Providencia I y el Centro Primario Principal V.

Adicionalmente, se cambiará de nombre al centro satélite existente denominado Andrés Bello, el cual pasará a denominarse Andrés Bello I.
